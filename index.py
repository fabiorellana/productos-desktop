...
class Product:
	...
	def delete_product(self):
		...
		try:
			...
			self.message['text'] = 'Por favor selecciona un elemento'
			return
		self.message['text'] = ''
		name =  self.tree.item(self.tree.selection())['text']
		query = 'DELETE FROM product WHERE name = ?'
		self.run_query(query, (name, ))
		self.message['text'] = 'El elemento {} ha sido eliminado satisfactoriamente'.format(name)
		self.get_products()
	...
	def edit_records(self, new_name, name, new_price, old_price):
		...
		self.message['text'] = 'El elemento {} ha sido editado satisfactoriamente'.format(name)
		self.get_products()
